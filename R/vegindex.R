...
#' Boochs et al. (1990)\cr 
#' Boochs2 \tab \eqn{D_{720}} \tab Boochs et al.
#' (1990)\cr 
#' CAI \tab \eqn{0.5\cdot
#' (R_{2000}+R_{2200})-R_{2100}}{0.5*(R_{2000}+R_{2200})-R_{2100}} \tab Nagler
#' et al. (2003)\cr 
#' CARI \tab \eqn{a = (R_{700}-R_{550}) / 150} \tab Kim et al.
#' (1994)\cr \tab \eqn{b = R_{550}-(a\cdot 550)}{b = R_{550}-(a*550)} \tab \cr
#' \tab \eqn{R_{700}\cdot \textnormal{abs}(a\cdot
#' 670+R_{670}+b)/R_{670}\cdot}{R_{700}abs(a670+R_{670}+b)/R_{670}} \tab \cr
#' \tab \eqn{(a^2+1)^{0.5}} \tab \cr 
#' Carter \tab \eqn{R_{695}/R_{420}} \tab
#' Carter (1994)\cr 
#' Carter2 \tab \eqn{R_{695}/R_{760}} \tab Carter (1994)\cr
#' Carter3 \tab \eqn{R_{605}/R_{760}} \tab Carter (1994)\cr 
#' Carter4 \tab
#' \eqn{R_{710}/R_{760}} \tab Carter (1994)\cr 
#' Carter5 \tab
#' \eqn{R_{695}/R_{670}} \tab Carter (1994)\cr 
#' Carter6 \tab \eqn{R_{550}} \tab
#' Carter (1994)\cr 
#' CI \tab \eqn{R_{675}\cdot
#' R_{690}/R_{683}^2}{R_{675}*R_{690}/R_{683}^2} \tab Zarco-Tejada et al. \cr
#' \tab \tab (2003)\cr 
#' CI2 \tab \eqn{R_{760}/R_{700}-1} \tab Gitelson et al. (2003) \cr 
#' ClAInt \tab \eqn{\int_{600 nm}^{735 nm} R} \tab Oppelt and Mauser\cr \tab 
#' \tab (2004)\cr 
#' CRI1 \tab \eqn{1/R_{515}-1/R_{550}} \tab Gitelson et al. (2003)\cr 
#' CRI2 \tab \eqn{1/R_{515}-1/R_{770}} \tab Gitelson et al. (2003)\cr 
#' CRI3 \tab \eqn{1/R_{515}-1/R_{550}\cdot
#' R_{770}}{1/R_{515}-1/R_{550}*R_{770}} \tab Gitelson et al. (2003)\cr 
#' CRI4 \tab \eqn{1/R_{515}-1/R_{700}\cdot R_{770}}{1/R_{515}-1/R_{700}*R_{770}}
#' \tab Gitelson et al. (2003)\cr 
#' D1 \tab \eqn{D_{730}/D_{706}} \tab Zarco-Tejada et al. \cr \tab \tab (2003)\cr 
#' D2 \tab \eqn{D_{705}/D_{722}}\tab Zarco-Tejada et al. \cr \tab \tab (2003)\cr 
...
#' Datt4 \tab \eqn{R_{672}/(R_{550}\cdot
#' R_{708})}{R_{672}/(R_{550}*R_{708})} \tab Datt (1998) \cr 
#' Datt5 \tab \eqn{R_{672}/R_{550}} \tab Datt (1998) \cr 
#' Datt6 \tab \eqn{(R_{860})/(R_{550}\cdot R_{708})}{(R_{860})/(R_{550}*R_{708})} \tab
#' Datt (1998) \cr 
#' Datt7 \tab \eqn{(R_{860} - R_{2218})/(R_{860} - R_{1928})}
#' \tab Datt (1999a) \cr 
#' Datt8 \tab \eqn{(R_{860} - R_{1788})/(R_{860} - R_{1928})} \tab Datt (1999a) \cr 
#' DD \tab \eqn{(R_{749}-R_{720})-(R_{701}-R_{672})} \tab le Maire et al. (2004)\cr DDn
...
#' \cr \tab \tab (2003)\cr 
#' DWSI1 \tab \eqn{R_{800}/R_{1660}}\tab Apan et al.
#' (2004)\cr 
...
#' \eqn{(\max(D_{650:750})+\max(D_{500:550}))} \tab (1994)\cr 
#' EGFR \tab
#' \eqn{\max(D_{650:750})/\max(D_{500:550})} \tab Penuelas et al. (1994)\cr 
#' EVI \tab \eqn{2.5\cdot ((R_{800}-R_{670})/}{2.5*((R_{800}-R_{670})/} \tab 
#' Huete et al. (1997)\cr \tab \eqn{(R_{800}-(6\cdot R_{670})-(7.5\cdot
#' R_{475})+1))}{(R_{800}-(6*R_{670})-(7.5*R_{475})+1))} \tab \cr 
...
#' LWVI_2 \tab \eqn{(R_{1094}-R_{1205}) / (R_{1094}+R_{1205})} \tab
#' Galvao et al. (2005)\cr 
...
#' Daughtry et al. (2000)\cr \tab \eqn{(R_{700}/R_{670})} \tab \cr 
...
#' et al. (2008)\cr \tab \eqn{ (R_{750}/R_{705})} \tab \cr 
#' MCARI2/OSAVI2\tab
#' \tab Wu et al. (2008)\cr 
#' mND705 \tab \eqn{(R_{750}-R_{705})/(R_{750}+R_{705}-2\cdot
#' R_{445})}{(R_{750}-R_{705})/(R_{750}+R_{705}-2*R_{445})} \tab 
#' Sims and Gamon (2002)\cr 
#' mNDVI \tab \eqn{(R_{800}-R_{680})/(R_{800}+R_{680}-2\cdot
#' R_{445})}{(R_{800}-R_{680})/(R_{800}+R_{680}-2*R_{445})} \tab Sims and Gamon
#' (2002)\cr 
#' MPRI \tab \eqn{(R_{515}-R_{530})/(R_{515}+R_{530})} \tab
#' Hernandez-Clemente et al.\cr \tab \tab (2011)\cr 
...
#' (1996)\cr 
#' mSR705 \tab \eqn{(R_{750}-R_{445})/(R_{705}-R_{445})} \tab Sims
#' and Gamon (2002)\cr 
#' MTCI \tab \eqn{(R_{754}-R_{709})/(R_{709}-R_{681})} \tab
#' Dash and Curran (2004)\cr 
#' MTVI \tab \eqn{1.2\cdot (1.2\cdot
#' (R_{800}-R_{550})-}{1.2*(1.2*(R_{800}-R_{550})-} \tab Haboudane et al.\cr
#' \tab \eqn{2.5\cdot (R_{670}-R_{550}))}{2.5* (R_{670}-R_{550}))} \tab
#' (2004)\cr 
#' NDLI\tab \eqn{(log(1/R_{1754}) - log(1/R_{1680}))/} \tab Serrano
#' et al. (2002) \cr \tab \eqn{(log(1/R_{1754}) + log(1/R_{1680}))} \tab \cr
#' NDNI\tab \eqn{(log(1/R_{1510}) - log(1/R_{1680}))/} \tab Serrano et al.
#' (2002) \cr \tab \eqn{(log(1/R_{1510}) + log(1/R_{1680}))} \tab \cr 
#' NDVI \tab
#' \eqn{(R_{800}-R_{680}) / (R_{800}+R_{680})} \tab Tucker (1979)\cr 
#' NDVI2 \tab
#' \eqn{(R_{750}-R_{705})/(R_{750}+R_{705})} \tab Gitelson and Merzlyak \cr
#' \tab \tab (1994)\cr 
#' NDVI3 \tab \eqn{(R_{682}-R_{553})/(R_{682}+R_{553})}
#' \tab Gandia et al. (2004)\cr NDWI \tab \eqn{(R_{860}-R_{1240}) /
#' (R_{860}+R_{1240})} \tab Gao (1996)\cr 
#' NPCI \tab
...
#' OSAVI2 \tab \eqn{(1+0.16)
#' \cdot (R_{750}-R_{705})/}{(1+0.16)*(R_{750}-R_{705})/} \tab Wu et al.
#' (2008)\cr \tab \eqn{(R_{750}+R_{705}+0.16)} \tab \cr 
#' PARS \tab
#' \eqn{R_{746}/R_{513}} \tab Chappelle et al. (1992)\cr 
#' PRI \tab
...
#' \cr \tab \tab (2013)\cr 
#' PRI*CI2 \tab \eqn{\textnormal{PRI} \cdot
#' \textnormal{CI}2}{PRI*CI2} \tab Garrity et al. (2011)\cr 
#' PSRI \tab
#' \eqn{(R_{678}-R_{500}/R_{750}} \tab Merzlyak et al. (1999)\cr 
#' PSSR \tab
#' \eqn{R_{800}/R_{635}} \tab Blackburn (1998)\cr 
#' PSND \tab
#' \eqn{(R_{800}-R_{470})/(R_{800}-R_{470})} \tab Blackburn (1998)\cr 
#' PWI \tab
#' \eqn{R_{970}/R_{900}} \tab Penuelas et al. (1997)\cr 
#' RDVI \tab
#' \eqn{(R_{800}-R_{670})/\sqrt{R_{800}+R_{670}}} \tab Roujean and Breon
#' (1995)\cr % RDVI \tab \eqn{(R_{800}-R_{670})/(R_{800}+R_{670})^{0.5}} \tab
#' Roujean and Breon (1995)\cr 
#' REP_LE \tab Red-edge position through linear
#' extrapolation.  \tab Cho and Skidmore (2006)\cr 
#' REP_Li \tab
...
#' \eqn{(R_{740}-R_{700}))} \tab \cr 
#' SAVI \tab \eqn{(1+L)\cdot
#' (R_{800}-R_{670})/(R_{800}+R_{670}+L)}{(1+L)*(R_{800}-R_{670})/(R_{800}+R_{670}+L)}
#' \tab Huete (1988)\cr 
#' SIPI \tab \eqn{(R_{800}-R_{445})/(R_{800}-R_{680})}
#' \tab Penuelas et al. (1995),\cr \tab \tab Penuelas et al. (1995a) \cr 
#' SPVI
#' \tab \eqn{0.4\cdot 3.7\cdot (R_{800}-R_{670})-1.2\cdot
#' }{0.4*3.7*(R_{800}-R_{670})-1.2*} \tab Vincini et al. (2006)\cr \tab
#' \eqn{((R_{530}-R_{670})^2)^{0.5}} \tab \cr 
#' SR \tab \eqn{R_{800}/R_{680}}
#' \tab Jordan (1969)\cr SR1 \tab \eqn{R_{750}/R_{700}} \tab Gitelson and
#' Merzlyak \cr \tab \tab (1997)\cr 
#' SR2 \tab \eqn{R_{752}/R_{690}} \tab Gitelson and Merzlyak \cr \tab \tab (1997)\cr 
#' SR3 \tab \eqn{R_{750}/R_{550}} \tab Gitelson and Merzlyak \cr \tab \tab (1997)\cr 
...
#' \tab \tab (1994)\cr 
#' SWIR FI\tab \eqn{R_{2133}^2/(R_{2225} \cdot R_{2209}^3}
#' \tab Levin et al. (2007)\cr 
#' SWIR LI\tab \eqn{3.87 \cdot (R_{2210} -
#' R_{2090}) - } \tab Lobell et al. (2001)\cr \tab \eqn{27.51 \cdot (R_{2280} -
#' R_{2090}) - 0.2} \tab \cr 
#' SWIR SI\tab \eqn{-41.59 \cdot (R_{2210} -
#' R_{2090}) + } \tab Lobell et al. (2001)\cr \tab \eqn{1.24 \cdot (R_{2280} -
#' R_{2090}) + 0.64} \tab \cr 
#' SWIR VI\tab \eqn{37.72 \cdot (R_{2210} -
...
#' R_{480} ))} \tab Hunt et al. (2013)\cr 
#' TVI \tab \eqn{0.5\cdot (120\cdot
#' (R_{750}-R_{550})-}{0.5(120(R_{750}-R_{550})-} \tab Broge and Leblanc \cr
#' \tab \eqn{200\cdot (R_{670}-R_{550}))}{200*(R_{670}-R_{550}))} \tab
#' (2000)\cr 
#' Vogelmann \tab \eqn{R_{740}/R_{720}} \tab Vogelmann et al.
#' (1993)\cr 
#' Vogelmann2 \tab \eqn{(R_{734}-R_{747})/(R_{715}+R_{726})} \tab
#' Vogelmann et al. (1993)\cr 
#' Vogelmann3 \tab \eqn{D_{715}/D_{705}} \tab
#' Vogelmann et al. (1993)\cr 
#' Vogelmann4 \tab
